...
const infoRendering = ()=>{
   ...
   <br>
    <div class="heading">
        <p  class="heading1">WE'RE</p>
        <p  class="heading2">COMING</p>
        <p  class="heading3">SOON</p>
    </div>

    <div class="info-paragraph">
          <p>Hello fellow shoppers! We're currently building our new
            fashion store. Add your email below to stay up-to-date
            with announcements and our launch deals. Email Address</p>
    </div>
    ...
    <div class="form">
        ...
        >
          <label>
            <input id="form-email" class="email-input" type="email" placeholder="Email Address" name="email">
          </label>
        
          <img class="error" id="email-image"
        ...
        />
          ...
          <span class="email-error-text" id="email-span" style="color: hsl(0, 93%, 68%);">Please provide a valid email !</span>
        </form>
    </div>
    `

    apparel.appendChild(info);
}
infoRendering();